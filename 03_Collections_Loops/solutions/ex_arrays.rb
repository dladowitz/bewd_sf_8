...
# HINT: You will reuse this array below.b
...
puts "The internet is full of #{my_string} and Kittens, though I wish there were less #{categories.first}."
